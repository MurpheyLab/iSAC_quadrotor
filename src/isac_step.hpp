  ...
  public:
	...
	dt_win = maxdt;//initial control duration
      ...
      if ( u2Search ) { 
		...
		//MinSearch2( cntrlCost, t0, tf, lclMin, d_actions.default_actions );//search inbetween actions 
